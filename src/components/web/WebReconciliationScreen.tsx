...
interface WebReconciliationScreenProps {
  onBack: () => void;
}

const WebReconciliationScreen = ({ onBack }: WebReconciliationScreenProps) => {
      ...
      <div className="bg-white border-b border-gray-200 px-6 py-4">
        <div className="max-w-4xl mx-auto flex items-center">
          ...
          <div className="flex items-center">
            ...
            />
            <div>
              <h1 className="text-xl font-bold text-kitadi-navy">Adicionar Reconciliação</h1>
              <p className="text-sm text-gray-500">Agente - Transações manuais de reconciliação</p>
            </div>
          </div>
        </div>
      </div>
...
export default WebReconciliationScreen;