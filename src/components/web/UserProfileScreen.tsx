...
const UserProfileScreen = ({
  ...
  const [documents] = useState<Document[]>([{
    ...
    type: 'proof_address',
    documentType: 'Comprovativo de Morada'
  }, {
    id: 'doc003',
    name: 'Licença Comercial',
    submissionDate: '2024-01-13',
    type: 'business_license',
    documentType: 'Licença Comercial'
  }]);
  ...
  const updateBusinessProfile = () => {
    ...
    setBusinessProfiles(businessProfiles.map(profile => profile.id === editingProfile.id ? editingProfile : profile));
  ...
  return <div className="w-full">
      <PageHeader title="Perfil do Utilizador" description={phoneNumber} onBack={onBack} />
            ...
            <Card className="w-full">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-2 mb-4">
                  <Checkbox id="identity-verified" checked={identityVerified} onCheckedChange={checked => setIdentityVerified(checked === true)} />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="firstName" value={userData.firstName} onChange={e => setUserData({
                    ...userData,
                  ...
                  <div>
                    ...
                    <Input id="middleName" value={userData.middleName} onChange={e => setUserData({
                    ...userData,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="lastName" value={userData.lastName} onChange={e => setUserData({
                    ...userData,
                  ...
                  <div>
                    ...
                    <select id="civilStatus" value={userData.civilStatus} onChange={e => setUserData({
                    ...userData,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="idNumber" value={userData.idNumber} onChange={e => setUserData({
                    ...userData,
                  ...
                  <div>
                    ...
                    <select id="nationality" value={userData.nationality} onChange={e => setUserData({
                    ...userData,
                    nationality: e.target.value
                  })} disabled={!identityVerified} className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <Input id="dateOfBirth" type="date" value={userData.dateOfBirth} onChange={e => setUserData({
                    ...userData,
                  ...
                  <div>
                    ...
                    <Input id="expiryDate" type="date" value={userData.expiryDate} onChange={e => setUserData({
                    ...userData,
                ...
                {identityVerified && <div>
                    <Label htmlFor="fiscalNumber">Número Fiscal (Opcional)</Label>
                    <Input id="fiscalNumber" placeholder="Ex: 123456789" value={fiscalNumber} onChange={e => setFiscalNumber(e.target.value)} />
                  </div>}

                <div>
                  <Label htmlFor="status">Estado da Conta</Label>
                  <Select value={userStatus} onValueChange={(value: any) => setUserStatus(value)} disabled={userStatus === 'PENDING_KYC'}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                  ...
                  {userStatus === 'PENDING_KYC' && <p className="text-xs text-amber-600 mt-1">
            ...
            <Card className="w-full">
                    ...
                    <DialogContent>
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <Input id="profileName" placeholder="Ex: Silva Commerce Lda" value={newProfileName} onChange={e => setNewProfileName(e.target.value)} />
                        </div>
                         <div>
                           <Label htmlFor="profileLocation">Localização</Label>
                           <div className="flex gap-2">
                             <Input id="profileLocation" placeholder="Ex: São Tomé" value={newProfileLocation} onChange={e => setNewProfileLocation(e.target.value)} />
                        ...
                        <div>
                         ...
                         <div>
                           ...
                           <Input id="taxId" placeholder="Ex: 123456789" value={newTaxId} onChange={e => setNewTaxId(e.target.value)} />
                         </div>
                           <div>
                             <Label htmlFor="gpsCoordinates">Coordenadas GPS</Label>
                             <div className="flex gap-2">
                               <Input id="gpsCoordinates" placeholder="Ex: 0.3365° N, 6.7273° E" value={newGpsCoordinates} onChange={e => setNewGpsCoordinates(e.target.value)} />
                         ...
                         <div>
                           ...
                           <textarea id="description" placeholder="Descrição do negócio" className="flex w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 min-h-[80px]" value={newDescription} onChange={e => setNewDescription(e.target.value)} />
                         </div>
                        <div className="flex gap-2">
              ...
              <CardContent>
                <Table>
                  ...
                  <TableBody>
                    {businessProfiles.map(profile => <TableRow key={profile.id}>
                        ...
                        <TableCell>
                          <div className="flex gap-2">
                              ...
                              <DialogContent>
                                ...
                                {editingProfile && <div className="space-y-4">
                                    <div>
                                      ...
                                      <Input id="editProfileName" value={editingProfile.name} onChange={e => setEditingProfile({
                                  ...editingProfile,
                                  name: e.target.value
                                })} />
                                    </div>
                                    <div>
                                      ...
                                      <Input id="editProfileLocation" value={editingProfile.location} onChange={e => setEditingProfile({
                                  ...editingProfile,
                                  location: e.target.value
                                     ...
                                     <div>
                                       ...
                                       <Select value={editingProfile.businessType} onValueChange={value => setEditingProfile({
                                  ...editingProfile,
                                  businessType: value
                                })}>
                                         <SelectTrigger>
                                     ...
                                     <div>
                                       ...
                                       <Select value={editingProfile.businessSize} onValueChange={value => setEditingProfile({
                                  ...editingProfile,
                                  businessSize: value
                                })}>
                                         <SelectTrigger>
                                     ...
                                     <div>
                                       ...
                                       <Select value={editingProfile.district} onValueChange={value => setEditingProfile({
                                  ...editingProfile,
                                  district: value
                                })}>
                                         <SelectTrigger>
                                     ...
                                     <div>
                                       ...
                                       <Input id="editTaxId" value={editingProfile.taxId} onChange={e => setEditingProfile({
                                  ...editingProfile,
                                  taxId: e.target.value
                                       ...
                                       <div>
                                         ...
                                         <div className="flex gap-2">
                                           <Input id="editGpsCoordinates" value={editingProfile.gpsCoordinates} onChange={e => setEditingProfile({
                                    ...editingProfile,
                                    ...
                                    if ("geolocation" in navigator) {
                                     ...
                                     <div>
                                       ...
                                       <textarea id="editDescription" className="flex w-full rounded-md border border-input bg-background px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 min-h-[80px]" value={editingProfile.description} onChange={e => setEditingProfile({
                                  ...editingProfile,
                            ...
                            <Button size="sm" variant="destructive" onClick={() => removeBusinessProfile(profile.id)}>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input id="documentName" placeholder="Ex: Bilhete de Identidade" value={documentName} onChange={e => setDocumentName(e.target.value)} />
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <Input id="documentFile" type="file" accept=".pdf,.jpg,.jpeg,.png" onChange={e => setSelectedFile(e.target.files?.[0] || null)} />
                    </div>
                ...
                <Table>
                  ...
                  <TableBody>
                    {documents.map(document => <TableRow key={document.id}>
                        ...
                        <TableCell>
                          <Button size="sm" variant="outline" onClick={() => downloadDocument(document.name)}>
