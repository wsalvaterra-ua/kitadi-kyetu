...
const Dashboard = ({ 
  ...
  const baseQuickActions = [
    { icon: Send, label: 'Enviar', color: 'bg-kitadi-orange', onClick: onSend },
    { icon: Smartphone, label: 'Comprar\nRecarga', color: 'bg-kitadi-orange', onClick: onPay },
    { icon: Plus, label: 'Depósito', color: 'bg-kitadi-orange', onClick: onTopUp },
    { icon: ArrowDownToLine, label: 'Levantar', color: 'bg-kitadi-orange', onClick: onWithdraw },
  ];

  // Additional business actions
  const businessActions = [
    { icon: Smartphone, label: 'Receber\nPagamento', color: 'bg-kitadi-orange', onClick: onCodeInput },
    { icon: Users, label: 'Gerir\nUtilizadores', color: 'bg-kitadi-orange', onClick: onUserManagement },
    { icon: FileText, label: 'Extrato\nCSV', color: 'bg-kitadi-orange', onClick: onExtract },
    { icon: Bell, label: 'Receber\nNotificações', color: 'bg-kitadi-orange', onClick: handleNotificationSettings },
  ];

  // Agent specific actions
  const agentActions = [
    { icon: Send, label: 'Enviar\nDinheiro', color: 'bg-kitadi-orange', onClick: onSend },
    { icon: Smartphone, label: 'Receber\nPagamento', color: 'bg-kitadi-orange', onClick: onCodeInput },
    { icon: Receipt, label: 'Reconciliação', color: 'bg-kitadi-orange', onClick: onReconciliation },
    { icon: Users, label: 'Criar\nContas', color: 'bg-kitadi-orange', onClick: onAccountCreation },
    { icon: FileText, label: 'Extrato\nCSV', color: 'bg-kitadi-orange', onClick: onExtract },
    { icon: Bell, label: 'Receber\nNotificações', color: 'bg-kitadi-orange', onClick: handleNotificationSettings },
  ];
  ...
  const getQuickActions = () => {
    if (!activeAccount.verified) {
      ...
      return [
        { icon: FileText, label: 'Extrato\nCSV', color: 'bg-kitadi-orange', onClick: onExtract },
        { icon: Bell, label: 'Receber\nNotificações', color: 'bg-kitadi-orange', onClick: handleNotificationSettings },
        { icon: Unlink, label: 'Dissociar', color: 'bg-kitadi-orange', onClick: () => handleDissociate(activeAccount.id) }
      ];
    }
